...
async function handleRequest(request) {
  ...
  <style>
    body {background: #FFFFFF;background-image: url(https://api.btstu.cn/sjbz/api.php?lx=dongman&type=zsy&format=images);}
  ...
  <body>
    <div class="downwrap">
      <input class="downurl" placeholder="Please enter the download URL">
      <a class="fullurl" href="" target="_blank"></a>
    </div>
    <a class="project" href="https://payday2.eu.org" target="_blank">Powered By payday4478</a>
    <script>
